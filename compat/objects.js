...
export { default as cloneDeep } from './objects/cloneDeep';
export { default as create } from './objects/create';
export { default as defaults } from './objects/defaults';
export { default as extend } from './objects/assign';
export { default as findKey } from './objects/findKey';
export { default as findLastKey } from './objects/findLastKey';
export { default as forIn } from './objects/forIn';
export { default as forInRight } from './objects/forInRight';
export { default as forOwn } from './objects/forOwn';
export { default as forOwnRight } from './objects/forOwnRight';
...
export { default as isPlainObject } from './objects/isPlainObject';
...
export { default as mapValues } from './objects/mapValues';
export { default as merge } from './objects/merge';
...
export { default as transform } from './objects/transform';
export { default as values } from './objects/values';
export { default as valuesIn } from './objects/valuesIn';
